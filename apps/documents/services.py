"""Backwards-compatible aggregator for `apps.documents.services`.

The implementation was split by responsibility:
- `mapping`   — deal → document data extraction / FieldMapping
...
`apps.documents.{api,public_views,tasks}` import as
