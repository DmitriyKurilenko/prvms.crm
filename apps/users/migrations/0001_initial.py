    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('owner', 'Owner'), ('admin', 'Admin'), ('manager', 'Manager'), ('viewer', 'Viewer')], max_length=20)),
                ('entity', models.CharField(choices=[('deals', 'Deals'), ('contacts', 'Contacts'), ('companies', 'Companies'), ('products', 'Products'), ('webforms', 'Web forms')], max_length=20)),
            ...
            options={
                'indexes': [models.Index(fields=['tenant', 'role'], name='users_rolep_tenant__76808e_idx'), models.Index(fields=['tenant', 'entity'], name='users_rolep_tenant__d35585_idx')],
