...
- **Бренд переведён на «ГусьБерри»** в виде текстового логотипа (без рисованного маскота — у проекта нет официального файла логотипа в репозитории, выдумывать его нельзя). Favicon — нейтральный знак: зелёный скруглённый квадрат с буквой «Г». Внутренние ссылки на ЛК (`/login`, `/register`, `/app`) сохранены.
...
- Текстовый логотип — временное решение до предоставления официального файла логотипа «ГусьБерри».
